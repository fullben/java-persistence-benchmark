...
import de.uniba.dsg.wss.util.RandomSelector;
...
/**
 * The generator can be used to generate a data model with JPA entity classes representing the
 * wholesale supplier data. The model and data generated by instances of this class are based on the
 * data model of the TPC-C benchmark.
 *
 * <p>The primary purpose is to generate a wholesale supplier data model consisting of the following
 * structures:
 *
 * <ul>
 *   <li>10 carriers
 *   <li>100 000 products
 *   <li>1 to n warehouses
 *   <li>100 000 stock items per warehouse
 *   <li>10 districts per warehouse
 *   <li>1 employee per district
 *   <li>3 000 customers per district
 *   <li>1 payment per customer
 *   <li>3 000 orders per district
 * </ul>
 *
 * <p>While the size of the data model can be configured through the constructors provided by the
 * class, certain attributes and properties used during generation are internal constant values of
 * this class and can thus not be configured.
 *
